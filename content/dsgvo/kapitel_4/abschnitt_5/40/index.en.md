...
linkTitle = 'Art. 40 - Codes of conduct'
slug = 'art-40'
...
{{< lit a >}}fair and transparent processing;{{< /lit >}}
{{< lit b >}}the legitimate interests pursued by controllers in specific contexts;{{< /lit >}}
{{< lit c >}}the collection of personal data;{{< /lit >}}
{{< lit d >}}the pseudonymisation of personal data;{{< /lit >}}
{{< lit e >}}the information provided to the public and to data subjects;{{< /lit >}}
{{< lit f >}}the exercise of the rights of data subjects;{{< /lit >}}
{{< lit g >}}the information provided to, and the protection of, children, and the manner in which the consent of the holders of parental responsibility over children is to be obtained;{{< /lit >}}
{{< lit h >}}the measures and procedures referred to in Articles 24 and 25 and the measures to ensure security of processing referred to in Article 32;{{< /lit >}}
{{< lit i >}}the notification of personal data breaches to supervisory authorities and the communication of such personal data breaches to data subjects;{{< /lit >}}
{{< lit j >}}the transfer of personal data to third countries or international organisations; or{{< /lit >}}
{{< lit k >}}out-of-court proceedings and other dispute resolution procedures for resolving disputes between controllers and data subjects with regard to processing, without prejudice to the rights of data subjects pursuant to Articles 77 and 79.{{< /lit >}}
{{< /abs >}}
