...
linkTitle = 'Art. 36 - Prior consultation'
slug = 'art-36'
...
{{< lit a >}}where applicable, the respective responsibilities of the controller, joint controllers and processors involved in the processing, in particular for processing within a group of undertakings;{{< /lit >}}
{{< lit b >}}the purposes and means of the intended processing;{{< /lit >}}
{{< lit c >}}the measures and safeguards provided to protect the rights and freedoms of data subjects pursuant to this Regulation;{{< /lit >}}
{{< lit d >}}where applicable, the contact details of the data protection officer;{{< /lit >}}
{{< lit e >}}the data protection impact assessment provided for in Article 35; and{{< /lit >}}
{{< lit f >}}any other information requested by the supervisory authority.{{< /lit >}}
{{< /abs >}}
