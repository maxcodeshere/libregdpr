...
linkTitle = 'Art. 61 - Mutual assistance'
slug = 'art-61'
...
{{< lit a >}}it is not competent for the subject-matter of the request or for the measures it is requested to execute; or{{< /lit >}}
{{< lit b >}}compliance with the request would infringe this Regulation or Union or Member State law to which the supervisory authority receiving the request is subject.{{< /lit >}}
{{< /abs >}}
